...
const Contact = () => {
  return (
    <div id="contact" className="w-full px-[-12%] py-10 scroll-mt-28 bg-[url('/footer-bg-color.png')] bg-no-repeat bg-center bg-[length:90%_auto]">
      ...
      <form className='max-w-2xl mx-auto'>
        ...
        <button className='py-3 px-8 w-max fex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500'>Submit Now <Image src={assets.right_arrow_white} alt='' className='w-4'/> </button>
