...
{serviceData.map((service, index) => (
  ...
  >
    ...
    <p className='text-sm text-gray-600 leading-5 dark:text-white'>{service.description}</p>
    <a href={service.link} className='flex items-center gap-2 text-sm mt-5 text-gray-600 dark:text-white'>
      Readmore 
      <ArrowRight size={22}/>
